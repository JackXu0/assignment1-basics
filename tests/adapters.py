...
def run_embedding(
    ...
    from cs336_basics.building_blocks import Embedding
...
def run_swiglu(
    ...
    from cs336_basics.building_blocks import SWIGLU
...
def run_scaled_dot_product_attention(
    ...
    """
    from cs336_basics.building_blocks import scaled_dot_product_attention
...
def run_multihead_self_attention(
    ...
    """
    from cs336_basics.building_blocks import MultiHeadAttention
...
def run_rope(
    ...
    """
    from cs336_basics.building_blocks import RotaryPositionalEmbedding
...
def run_transformer_block(
    ...
    """
    from cs336_basics.building_blocks import TransformerBlock
...
def run_transformer_lm(
    ...
    """
    from cs336_basics.building_blocks import TransformerLM
...
def run_rmsnorm(
    ...
    """
    from cs336_basics.building_blocks import RMSNorm
...
def run_get_batch(
    ...
    """
    from cs336_basics.building_blocks import get_batch
...
def run_softmax(in_features: Float[Tensor, " ..."], dim: int) -> Float[Tensor, " ..."]:
    ...
    """
    from cs336_basics.building_blocks import softmax
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    from cs336_basics.building_blocks import gradient_clipping
...
def get_adamw_cls() -> Any:
    ...
    """
    from cs336_basics.building_blocks import AdamW
    return AdamW
...
def run_get_lr_cosine_schedule(
    ...
    """
    from cs336_basics.building_blocks import lr_cosine_schedule
...
def run_save_checkpoint(
    ...
    """
    from cs336_basics.building_blocks import save_checkpoint
...
def run_load_checkpoint(
    ...
    """
    from cs336_basics.building_blocks import load_checkpoint
...
def get_tokenizer(
    ...
    """
    return Tokenizer(vocab, special_tokens, merges)
...
def run_train_bpe(
    ...
    **kwargs,
    ...
    # get pre tokens
    pre_tokenizer = PreTokenizer(input_path, special_tokens)
    pre_tokens = pre_tokenizer.get_pre_tokens()

    bpe_trainer = BPE_TRAINER(pre_tokens, special_tokens, vocab_size)
